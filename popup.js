...
function loadPopup() {
    window.onload = function(){
        ...
        var bitcoinIcon = document.getElementById("logo-icon");
        bitcoinIcon.onclick=function(e){
            var redirectWindow = window.open('https://www.bitcoin.org', '_blank');
        ...
        githubIcon.onclick=function(e){
            var redirectWindow = window.open('https://github.com/Alex-Werner/bitcoin-price', '_blank');
            redirectWindow.location;
        };
    }
